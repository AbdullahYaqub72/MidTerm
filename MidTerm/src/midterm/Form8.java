...
public class Form8 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i=0;i<MidTerm.MElist.size();i++)
        {
            ...
            {
                if(name.equals(MidTerm.MElist.get(i).getName())&&A3.equals(MidTerm.MIList.get(i).IName))
                {
                    flag=true;
                    MidTerm.MElist.remove(i);
                    MidTerm.MIList.remove(j);
        ...
        if(flag==false)
        {
            JOptionPane.showMessageDialog(null,"User has not Taken any Item");
        }
